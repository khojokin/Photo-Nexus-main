  ...
  async function handleSocial(provider: "google" | "apple") {
    ...
    try {
      await signUp.authenticateWithRedirect({
        ...
        redirectUrlComplete: `${window.location.origin}/settings`,
      });
    } catch (error) {
        ...
        <div className="w-full max-w-[360px] mx-auto lg:mx-0">
          ...
          <form onSubmit={(e) => void handleSubmit(e)} className="space-y-5">
            <div className="space-y-1">
              <label className="block text-[10px] text-white/30 uppercase tracking-[0.15em]">Username</label>
              <input
                type="text"
                value={username}
            ...
            <div className="space-y-1">
              <label className="block text-[10px] text-white/30 uppercase tracking-[0.15em]">Email address</label>
              <input
                type="email"
                value={email}
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full h-11 bg-white text-black text-[13px] font-medium hover:bg-white/90 active:bg-white/80 transition-colors disabled:opacity-40 flex items-center justify-center"
              >
                {emailLoading
