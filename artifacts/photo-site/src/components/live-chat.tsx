    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-foreground text-background rounded-full shadow-lg flex items-center justify-center hover:opacity-90 transition-all hover:scale-105"
      ...
      {open && (
        <div className={cn(
          "fixed bottom-6 right-6 z-50 w-80 sm:w-96 bg-background border border-border shadow-2xl flex flex-col transition-all",
          minimised ? "h-12" : "h-[480px]"
        )}>
          {/* Header */}
